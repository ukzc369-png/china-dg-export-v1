...
export default function HomePage({ go, lang, products, articles, onOpenArticle }: Props) {
  ...
  return <main className="hp">
    ...
    <footer className="hp-footer"><div className="hp-shell hp-footer-grid"><div><div className="hp-footer-brand"><span>CE</span><b>ChinaChemExport</b></div><p>{tx(t("We are a professional chemical exporter from China, committed to providing high-quality products, compliant solutions and reliable service to customers worldwide.","我们是一家专业的中国化工品出口商，致力于为全球客户提供高品质产品、合规解决方案与可靠服务。"),lang)}</p><div className="hp-social"><a href="#" aria-label="LinkedIn">in</a><a href="#" aria-label="Facebook">f</a><a href="https://wa.me/8618678695200" aria-label="WhatsApp">◉</a><a href="mailto:18678695200@163.com" aria-label="Email">✉</a></div></div><FooterCol title="Products" items={["Inorganic Chemicals","Organic Chemicals","Fine Chemicals","Water Treatment Chemicals","View All Products"]}/><FooterCol title="Services" items={["Product Sourcing","Quality Control","Documentation","Logistics & Shipping","After-sales Support"]}/><FooterCol title="Company" items={["About Us","Our Team","Certifications","News","Contact Us"]}/><div><h3>Contact Us</h3><p>✉ Email: 18678695200@163.com</p><p>☎ Tel: +86 186 7869 5200</p><p>◉ WhatsApp: +86 186 7869 5200</p><p>⌖ Address: Dongying, Shandong, China</p></div></div><div className="hp-shell hp-footer-bottom"><span>© 2026 ChinaChemExport. All Rights Reserved.</span><span>Privacy Policy　|　Terms of Use</span></div></footer>
