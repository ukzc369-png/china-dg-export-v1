...
export const coreRoutes = [
  { path: "/", title: "China Chemical Sourcing & Export Support", description: "Independent chemical sourcing and export coordination connected to Shandong supply, qualified repacking, inspection, dangerous-goods documentation, customs and shipping resources.", heading: "China Chemical Sourcing & Export Support", links: [["/chemical-sourcing", "How chemical sourcing works"], ["/contact", "Discuss your requirement"]] },
  { path: "/products", title: "Chemical Products Sourced from China", description: "Browse chemicals that an independent Shandong-based coordinator can help international buyers source, verify and prepare for export.", heading: "Chemical Products I Can Help You Source", links: [["/chemical-sourcing", "View sourcing process"], ["/contact", "Ask about a product"]] },
  { path: "/chemical-sourcing", title: "Chemical Sourcing in China from Shandong", description: "Independent chemical sourcing support for international buyers: supplier research, availability, specification, price, packing and export feasibility review.", heading: "Chemical Sourcing in China, Coordinated from Shandong", links: [["/products", "Browse products"], ["/contact", "Send a requirement"]] },
  { path: "/export-support", title: "Chemical Export Support from China", description: "Coordinate qualified repacking, inspection, dangerous-goods packaging documents, customs declaration, vessel booking and shipment follow-up for confirmed chemical supply.", heading: "Chemical Export Support from Preparation to Shipment", links: [["/chemical-sourcing", "Chemical sourcing"], ["/contact", "Review an export requirement"]] },
  { path: "/shandong-supply-base", title: "Shandong Petrochemical Supply Base", description: "Understand chemical sourcing in Shandong and Dongying, including regional products, supplier access, export services and connections to major ports.", heading: "Sourcing from Shandong's Petrochemical Supply Base", links: [["/products", "Browse products"], ["/contact", "Discuss Shandong sourcing"]] },
  { path: "/about", title: "About the Independent Chemical Sourcing Coordinator", description: "Meet Daniel Zhang, an independent chemical sourcing and export coordinator connecting international buyers with Shandong supply and qualified operating resources.", heading: "Your Local Chemical Sourcing Coordinator in Shandong", links: [["/chemical-sourcing", "How I work"], ["/contact", "Contact Daniel"]] },
  { path: "/insights", title: "Chemical Sourcing & Export Guides", description: "Practical buyer guides on Chinese chemical suppliers, specifications, packing, dangerous-goods documents and shipment preparation.", heading: "Practical Chemical Sourcing & Export Guides", links: [["/products", "Browse products"], ["/contact", "Discuss a buyer requirement"]] },
  { path: "/contact", title: "Contact a China Chemical Sourcing Coordinator", description: "Send product, specification, quantity, packing and destination details directly to an independent chemical sourcing and export coordinator in Shandong.", heading: "Tell Me What You Need to Source", links: [["/products", "Browse products"], ["/export-support", "Review export support"]] },
  { path: "/dangerous-goods", title: "Dangerous Goods Chemical Export", description: "Review dangerous-goods packaging, documentation, declaration and shipping coordination for chemical exports from China.", heading: "Dangerous Goods Chemical Export", links: [["/export-support", "Export support"], ["/contact", "Request a review"]] },
